import { _ as n$1, g as f$1, m as d$1, s as P$1, x as u$1 } from "./p-CHqRYvYm-d8cfvk2x.js";
import { t as d$2 } from "./p-ZjP4CjeZ-BnW-oeAv.js";
import { a as d$3 } from "./p-Baq1XyAy-DaUDKirg.js";
...
var y = async (n) => {
	if (n.leavingEl && n.animated && 0 !== n.duration) return n.animationBuilder ? n.animationBuilder : "ios" === n.mode ? (await import("./dist-QWbKndMw.js").then((n) => n.Mn)).iosTransitionAnimation : (await import("./dist-QWbKndMw.js").then((n) => n.An)).mdTransitionAnimation;
};
var h = async (n, e) => {
	await k(e, !0);
